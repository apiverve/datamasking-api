...
namespace APIVerve.API.DataMasking
{
    ...
    /// <summary>
    /// Client for the DataMasking API
    /// </summary>
    public class DataMaskingAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/datamasking";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "types", new ValidationRule { Type = "array", Required = false } }
        };
        ...
        public DataMaskingAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DataMaskingAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DataMaskingAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, DataMaskingQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(DataMaskingQueryOptions options)
        {
        ...
        public ResponseObj Execute(DataMaskingQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(DataMaskingQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(DataMaskingQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(DataMaskingQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(DataMaskingQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(DataMaskingQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(DataMaskingQueryOptions options)
        {
