...
namespace APIVerve\Datamasking;
...
/**
 * Client for the Data Masking API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/datamasking?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/datamasking';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DatamaskingClient] {$message}\n";
        }
    }
}
