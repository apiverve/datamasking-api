...
class datamaskingWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/datamasking');
        }
        ...
        this.validationRules = {"text":{"type":"string","required":true},"types":{"type":"array","required":false,"default":"[\"email\",\"phone\",\"ssn\",\"credit_card\",\"ip_address\",\"url\",\"date\"]"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/datamasking`);
        }
    }
...
module.exports = datamaskingWrapper;
