...
// Request contains the parameters for the Data Masking API.
//
// Parameters:
...
// ResponseData contains the data returned by the Data Masking API.
type ResponseData struct {
	Masked string `json:"masked"`
	Detected DetectedData `json:"detected"`
}

// DetectedData represents the detected object.
