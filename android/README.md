...
```gradle
dependencies {
    implementation 'com.github.apiverve:datamasking-api:1.1.12'
}
```
...
```java
import com.apiverve.datamasking.DataMaskingAPIClient;
import com.apiverve.datamasking.APIResponse;
import com.apiverve.datamasking.APIException;

// Initialize the client
DataMaskingAPIClient client = new DataMaskingAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/datamasking](https://docs.apiverve.com/ref/datamasking)
...
- **Documentation:** [https://docs.apiverve.com/ref/datamasking](https://docs.apiverve.com/ref/datamasking)
- **Issues:** [GitHub Issues](https://github.com/apiverve/datamasking-api/issues)
