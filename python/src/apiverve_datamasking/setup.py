...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/datamasking',
        'Source': 'https://github.com/apiverve/datamasking-api',
        'Bug Tracker': 'https://github.com/apiverve/datamasking-api/issues'
    },
    classifiers=[
