# Data Masking API - Examples

This folder contains example code for using the Data Masking API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/datamasking',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/datamasking");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/datamasking](https://docs.apiverve.com/ref/datamasking)
